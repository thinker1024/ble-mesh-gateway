...
#define	GPIO_BUTTON_MASTER      GPIO_PC5			//PWM1
#define	GPIO_BUTTON_SLAVE       GPIO_PD2			//PWM1
...
void switch_mode_master2slave(u8 m_master)
{
    ...
    cpu_sleep_wakeup(1, PM_WAKEUP_TIMER, clock_time() + 10*1000*CLOCK_SYS_CLOCK_1US);
    while(1);
}
