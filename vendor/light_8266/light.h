...
#define PULL_WAKEUP_SRC_PC2           PM_PIN_PULL_DEFAULT // LIGHT_PWM must 0(float) or 3(pull_down_100K )

// don't use GPIO_PB0(pwm5) of 8266, because its default status is ouput 1 as GPIO.
#define PWM_R     GPIO_PA1
#define PWM_G     GPIO_PA5
#define PWM_B     GPIO_PC1
#define PWM_W     GPIO_PC4
#define PWM_CW    GPIO_PC0
...
#define I2C_HW_SDA              GPIO_DI
#define I2C_HW_SCL              GPIO_CK
